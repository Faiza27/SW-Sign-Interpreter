...
class TestTextToSign(unittest.TestCase):
	...
	def test_TextInput(self):
		"""
		This function is going to match the text input (be careful) with the gif (be careful.gif)
		...
		"""
		s = 'E:\\signLang\\Gifs\\be careful.gif'
		actualOutput=textSign.text_to_sign(text="be careful")
