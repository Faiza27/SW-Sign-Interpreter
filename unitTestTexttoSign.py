...
class TestTextToSign(unittest.TestCase):
	...
	def test_TextInput(self):
		"""
		This function is going to match the text input (do you watch TV) with the gif (do you watch TV.gif)
		...
		"""
		s = 'E:\\signLang\\Gifs\\do you watch TV.gif'
		actualOutput=textSign.text_to_sign(text="do you watch TV")
