...
class TestTextToSign(unittest.TestCase):
	...
	def test_TextInput(self):
		"""
		This function is going to match the text input (good morning) with the gif (good morning.gif)
		...
		"""
		s = 'E:\\signLang\\Gifs\\good morning.gif'
		actualOutput=textSign.text_to_sign(text="good morning")
